...
<?php Form::Olustur("2",array("type"=>"password","name"=>"sifretekrar","required"=>"required")); ?></li>
 ...
 Form::Olustur("2",array("type"=>"text","name"=>"telefon","required"=>"required")); ?></li>  	
                         	 ...
                         	 <ul>
                         	 	...
                         	 	<ul>
							 <li class="text-info"><span class="text-danger">*</span> Güvenlik Kodu : <img src="<?php echo $veri["kaynak"]; ?>" id="capt"/><a onclick=reloadEt(); class="glyphicon glyphicon-refresh" id="reload"></a>
							 </li>
							 <li> <?php
